...
(function(jq$) {
    ...
    var postTemplate = {
		...
		"i18nEntityId" : 0,
		"i18nEntityName" : "",
		"academicYear.selectedOption" : "", //17672
		"code" : "",	// Winter2-2019
		"name" : "",	// Winter2-2019
		"beginDateString" : "",	 // Mar/01/2020
		"beginDate.day" : "",
		"beginDate.month" : "",
		"beginDate.year" : "",
		"endDateString" : "",	 // Apr/30/2020
		"endDate.day" : "",
		"endDate.month" : "",
		"endDate.year" : "",
		"campusFisId" : "", //W2-2020
		"svEnrollmentBeginDateString" : " ",
		"svEnrollmentBeginDate.day" : " ",
		"svEnrollmentBeginDate.month" : " ",
		"svEnrollmentBeginDate.year" : " ",
		"svEnrollmentBeginDate.hour" : " ",
		"svEnrollmentBeginDate.minute" : " ",
		"svEnrollmentBeginDate.ampm" : " ",
		"svEnrollmentEndDateString" : " ",
		"svEnrollmentEndDate.day" : " ",
		"svEnrollmentEndDate.month" : " ",
		"svEnrollmentEndDate.year" : " ",
		"svEnrollmentEndDate.hour" : " ",
		"svEnrollmentEndDate.minute" : " ",
		"svEnrollmentEndDate.ampm" : " ",
		"pvAvailabilityBeginDateString" : " ",
		"pvAvailabilityBeginDate.day" : " ",
		"pvAvailabilityBeginDate.month" : " ",
		"pvAvailabilityBeginDate.year" : " ",
		"pvAvailabilityBeginDate.hour" : " ",
		"pvAvailabilityBeginDate.minute" : " ",
		"pvAvailabilityBeginDate.ampm" : " ",
		"pvAvailabilityEndDateString" : " ",
		"pvAvailabilityEndDate.day" : " ",
		"pvAvailabilityEndDate.month" : " ",
		"pvAvailabilityEndDate.year" : " ",
		"pvAvailabilityEndDate.hour" : " ",
		"pvAvailabilityEndDate.minute" : " ",
		"pvAvailabilityEndDate.ampm" : " ",
		"pvEnrollmentBeginDateString" : " ",
		"pvEnrollmentBeginDate.day" : " ",
		"pvEnrollmentBeginDate.month" : " ",
		"pvEnrollmentBeginDate.year" : " ",
		"pvEnrollmentBeginDate.hour" : " ",
		"pvEnrollmentBeginDate.minute" : " ",
		"pvEnrollmentBeginDate.ampm" : " ",
		"pvEnrollmentEndDateString" : " ",
		"pvEnrollmentEndDate.day" : " ",
		"pvEnrollmentEndDate.month" : " ",
		"pvEnrollmentEndDate.year" : " ",
		"pvEnrollmentEndDate.hour" : " ",
		"pvEnrollmentEndDate.minute" : " ",
		"pvEnrollmentEndDate.ampm" : " ",
		"pvEnrollmentDeadlineDateString" : " ",
		"pvEnrollmentDeadlineDate.day" : " ",
		"pvEnrollmentDeadlineDate.month" : " ",
		"pvEnrollmentDeadlineDate.year" : " ",
		"pvEnrollmentDeadlineDate.hour" : " ",
		"pvEnrollmentDeadlineDate.minute" : " ",
		"pvEnrollmentDeadlineDate.ampm" : " ",
		"classMeetingBeginDateString" : " ",
		"classMeetingBeginDate.day" : " ",
		"classMeetingBeginDate.month" : " ",
		"classMeetingBeginDate.year" : " ",
		"classMeetingEndDateString" : " ",
		"classMeetingEndDate.day" : " ",
		"classMeetingEndDate.month" : " ",
		"classMeetingEndDate.year" : " ",
		"dropDeadlineDateString" : " ",
		"dropDeadlineDate.day" : " ",
		"dropDeadlineDate.month" : " ",
		"dropDeadlineDate.year" : " ",
		"refundDeadlineDateString" : " ",
		"refundDeadlineDate.day" : " ",
		"refundDeadlineDate.month" : " ",
		"refundDeadlineDate.year" : " ",
		"withdrawalDeadlineDateString" : " ",
		"withdrawalDeadlineDate.day" : " ",
		"withdrawalDeadlineDate.month" : " ",
		"withdrawalDeadlineDate.year" : " ",
		"gradingBasisDeadlineDateString" : " ",
		"gradingBasisDeadlineDate.day" : " ",
		"gradingBasisDeadlineDate.month" : " ",
		"gradingBasisDeadlineDate.year" : " ",
		"instructorPaymentDateString" : " ",
		"instructorPaymentDate.day" : " ",
		"instructorPaymentDate.month" : " ",
		"instructorPaymentDate.year" : " ",
		"daysToSendTBANotification" : "0"
	}
	...
	function d1_list_action (postData) {
		...
		return jq$.ajax({
			...
			url: 'https://'
			 ...
			 + '/srs/currmgr/semester/academicTerm.do',		
			data: postData,
    ...
    function d1_list_import () {
		...
		for (var i = rowStart; i < data.length; i++) {
			...
			postData["academicYear.selectedOption"] = fiscal_year[data[i][0]];
			postData.code = data[i][1];
			postData.name = data[i][1];
			postData.campusFisId = data[i][2];
			postData.beginDateString = data[i][3];
			postData["beginDate.day"] = d1_parse_date(data[i][3]).getDate();
			postData["beginDate.month"] = d1_parse_date(data[i][3]).getMonth();
			postData["beginDate.year"] = d1_parse_date(data[i][3]).getFullYear();
			postData.endDateString = data[i][4];
			postData["endDate.day"] = d1_parse_date(data[i][4]).getDate();
			postData["endDate.month"] = d1_parse_date(data[i][4]).getMonth();
			postData["endDate.year"] = d1_parse_date(data[i][4]).getFullYear();
